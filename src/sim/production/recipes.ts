...
const DEFS: readonly RecipeInput[] = [
  ...
  // --- Weapons (docs/02 + docs/03 weapon-archetype split) ---
  // Each archetype is its own smithing or workshop recipe so the
  // production chain has real labor + material costs per kit item,
  // and so military procurement can address them individually.
  {
    id: 'forge_gladius',
    inputs: { 'metal.iron': 2, 'material.lumber': 0.4, 'material.charcoal': 1 },
    labor: { smith: 1 },
    building: 'smithy',
    outputs: { 'goods.gladius': 4 },
    notes: 'Roman short sword. Primary infantry melee.',
  },
  {
    id: 'forge_hasta',
    inputs: { 'metal.iron': 1, 'material.lumber': 2, 'material.charcoal': 0.5 },
    labor: { smith: 1 },
    building: 'smithy',
    outputs: { 'goods.hasta': 6 },
    notes: 'Thrusting spear. More wood, less iron than a sword.',
  },
  {
    id: 'forge_pilum',
    inputs: { 'metal.iron': 2, 'material.lumber': 1.5, 'material.charcoal': 1 },
    labor: { smith: 1 },
    building: 'smithy',
    outputs: { 'goods.pilum': 5 },
    notes: 'Heavy throwing javelin; iron shank crumples on impact.',
  },
  {
    id: 'forge_dagger',
    inputs: { 'metal.iron': 0.5, 'material.charcoal': 0.5 },
    labor: { smith: 1 },
    building: 'smithy',
    outputs: { 'goods.dagger': 10 },
    notes: 'Pugio sidearm. Small iron blade, no haft.',
  },
  {
    id: 'forge_helmet',
    inputs: { 'metal.iron': 3, 'material.charcoal': 2 },
    labor: { smith: 1 },
    building: 'smithy',
    outputs: { 'goods.helmet': 2 },
  ...
  },
  {
    ...
    labor: { smith: 1 },
    building: 'smithy',
    outputs: { 'goods.body_armor': 1 },
    notes: 'Lorica (mail or scale). Slow to make; iron-heavy.',
  },
  {
    id: 'make_shield',
    ...
    labor: { carpenter: 1 },
    building: 'smithy',
    outputs: { 'goods.shield': 4 },
    notes: 'Scutum or parma. Wooden core, leather face, bronze trim.',
  },
  {
    id: 'make_bow',
    inputs: { 'material.wood': 0.3, 'material.leather': 0.5 },
    labor: { bowyer: 1 },
    building: 'smithy',
    outputs: { 'goods.bow': 4 },
    notes: 'Self or composite bow; leather stands in for sinew.',
  },
  {
    id: 'make_arrow',
    inputs: { 'material.wood': 0.05, 'metal.iron': 0.05 },
    labor: { fletcher: 1 },
    building: 'smithy',
    outputs: { 'goods.arrow': 60 },
    notes: 'Two quivers / day. Feathers folded into the labor.',
  },
  {
    id: 'make_sling',
    inputs: { 'material.leather': 0.3 },
    labor: { tailor: 1 },
    building: 'tailor_shop',
    outputs: { 'goods.sling': 8 },
    notes: 'Strap-and-pouch ranged weapon. Quick to make.',
  },
  {
    id: 'cast_sling_bullet',
    inputs: { 'metal.lead': 2, 'material.charcoal': 0.5 },
    labor: { smelter: 1 },
    building: 'bloomery',
    outputs: { 'goods.sling_bullet': 100 },
    notes: 'Lead casting. Two bundles of glandes per smelter-day.',
  },
  {
    id: 'build_cart',
